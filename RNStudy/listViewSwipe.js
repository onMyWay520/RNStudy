...
export default  class listViewSwipe extends Component {

    constructor(props) {
        super(props);
        this.ds = new ListView.DataSource({rowHasChanged: (r1, r2) => r1 !== r2});
        this.state = {
            listType: 'FlatList',  //fill填充数组
            listViewData: Array(20).fill('').map((_,i) => ({key: `${i}`, text: `Row${i}`})),
        };
    }
    ...
    deleteRow(rowMap, rowKey) {
        ...
        newData.splice(prevIndex, 1);//删除指定的元素
