...
export default class RadioGroup extends Component {
    ...
    constructor(props) {
        ...
        this.state = {
            ...
            data: this.props.data ? this.props.data : [{title: '男',}, {title: '女'},{title: '你猜'}],
        };
    }
    ...
    renderRadioButton(array, item, onPress, index, sexIndex) {
        ...
        return (
            <TouchableOpacity key={index} onPress={()=> {
                ...
                <Image style={[{width: 20, height: 20,left:20},this.props.imageStyle]} source={image}/>
                <Text style={[{left: 45},this.props.textStyle]}>{item.title}</Text>
            </TouchableOpacity>
        )
    }
}
